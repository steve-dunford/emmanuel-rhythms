...
class Dependencies {
  ...
  static register() {
    ...
    GetIt.I.registerSingleton<NotificationRepository>(FirebaseNotificationRepository());
    ...
    GetIt.I.registerSingleton<SendNotificationViewModel>(SendNotificationViewModel(GetIt.I.get()));
  }
}